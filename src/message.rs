...
impl Message {
    pub fn new(uid: u32, seq: u32, raw_data: Vec<u8>) -> Self {
...
mod tests {
    ...
    fn test_only_me_star_filter_behavior() {
        ...
        assert_eq!(matching_email.compare(&filter), (true, true, true, true));
        assert_eq!(non_matching_email.compare(&filter), (true, true, false, false));
    }
    ...
    fn test_header_parsing_extracts_subject_and_addresses() {
        ...
        let message = Message::new(10, 10, raw_data);
    ...
    fn test_header_parsing_gracefully_handles_missing_headers() {
        ...
        let message = Message::new(99, 99, raw_data);

        assert_eq!(message.uid, 99);
        assert_eq!(message.seq, 99);
